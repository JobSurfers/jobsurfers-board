...
async def main():
    ...
    print("\n== Static HTML ==")
    all_jobs += scrape_static("https://work.withforward.com/", "Forward", "forward", ["h2 a","h3 a","a.job",".job-title"])
    all_jobs += scrape_static("https://www.onstrider.com/jobs", "Strider", "strider", [".job-title","h3 a",".position-title","h2 a"])
    all_jobs += scrape_static("https://thehireboost.zohorecruit.com/jobs/Careers", "HireBoost", "hireboost", [".job-title","h3",".position",".jobs-list a"])
    all_jobs += scrape_static("https://hirelatam.com/jobs/", "HireLatam", "hirelatam", [".job-title","h3 a",".position","a.job"])
    all_jobs += scrape_static("https://jobs.worldteams.com/jobs", "Worldteams", "worldteams", [".job-title","h3",".position","h2 a"])
    all_jobs += scrape_static("https://www.howdylatam.com/oportunidades", "Howdy", "howdy", [".job-title","h3",".opening","h2 a"])
    all_jobs += scrape_static("https://kala-talent.com/opportunities/", "KalaTalent", "kalatalent", [".job-title","h3",".opportunity","h2 a"])
    all_jobs += scrape_static("https://webstarted.com/careers", "Webstarted", "webstarted", [".job-title","h3",".position","h2 a"])
    ...
    all_jobs += scrape_static("https://devlane.applytojob.com/apply", "Devlane", "devlane", [".job-title","h3","a.job",".position"])
